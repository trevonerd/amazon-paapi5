...
(function (root, factory) {
...
})(void 0, function (superagent, querystring) {
  'use strict';
  /**
   * @module ApiClient
   * @version 1.0.0
  ...
  exports.prototype.callApi = function callApi(path, httpMethod, apiName, pathParams, queryParams, collectionQueryParams, headerParams, formParams, bodyParam, authNames, contentTypes, accepts, returnType) {
    ...
    request.set(authHeader); // set collection query parameters
    ...
    request.set(requestHeaders); // set requestAgent if it is set by user

    request.set(this.requestAgent); // set request timeout
