...
(function (root, factory) {
...
})(void 0, function (ApiClient, GetBrowseNodesRequest, GetBrowseNodesResponse, GetItemsRequest, GetItemsResponse, GetVariationsRequest, GetVariationsResponse, ProductAdvertisingAPIClientException, ProductAdvertisingAPIServiceException, SearchItemsRequest, SearchItemsResponse) {
  'use strict';
  /**
   * Default service.
  ...
  var exports = function exports(apiClient) {
    ...
    this.getBrowseNodesWithHttpInfo = function (getBrowseNodesRequest) {
      var postBody = getBrowseNodesRequest; // verify the required parameter 'getBrowseNodesRequest' is set
      ...
      return this.apiClient.callApi('/paapi5/getbrowsenodes', 'POST', 'GetBrowseNodes', pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType);
    };
    /**
     * @param {module:model/GetBrowseNodesRequest} getBrowseNodesRequest GetBrowseNodesRequest
    ...
    this.getBrowseNodes = function (getBrowseNodesRequest) {
      return this.getBrowseNodesWithHttpInfo(getBrowseNodesRequest).then(function (response_and_data) {
    ...
    this.getItemsWithHttpInfo = function (getItemsRequest) {
      var postBody = getItemsRequest; // verify the required parameter 'getItemsRequest' is set
      ...
      return this.apiClient.callApi('/paapi5/getitems', 'POST', 'GetItems', pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType);
    };
    /**
     * @param {module:model/GetItemsRequest} getItemsRequest GetItemsRequest
    ...
    this.getItems = function (getItemsRequest) {
      return this.getItemsWithHttpInfo(getItemsRequest).then(function (response_and_data) {
        return response_and_data.data;
      });
    };
    /**
    ...
    this.getVariationsWithHttpInfo = function (getVariationsRequest) {
      var postBody = getVariationsRequest; // verify the required parameter 'getVariationsRequest' is set
      ...
      return this.apiClient.callApi('/paapi5/getvariations', 'POST', 'GetVariations', pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType);
    };
    /**
     * @param {module:model/GetVariationsRequest} getVariationsRequest GetVariationsRequest
    ...
    this.getVariations = function (getVariationsRequest) {
      return this.getVariationsWithHttpInfo(getVariationsRequest).then(function (response_and_data) {
        return response_and_data.data;
      });
    };
    /**
    ...
    this.searchItemsWithHttpInfo = function (searchItemsRequest) {
      var postBody = searchItemsRequest; // verify the required parameter 'searchItemsRequest' is set
      ...
      return this.apiClient.callApi('/paapi5/searchitems', 'POST', 'SearchItems', pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType);
    };
    /**
     * @param {module:model/SearchItemsRequest} searchItemsRequest SearchItemsRequest
    ...
    this.searchItems = function (searchItemsRequest) {
      return this.searchItemsWithHttpInfo(searchItemsRequest).then(function (response_and_data) {
        return response_and_data.data;
      });
    };
  };
